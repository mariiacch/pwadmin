...
//filtra la data , los users que se queden son los que no coinciden con el user que se selecciono  setUsuarios(usuarios.filter(user=>user._id!==userSeleccionado._id));
  const eliminar = async()=>{
    ...
    try{
    await axiosInstance.delete(Url + clientSeleccionado._id )
  ...
  const editar = async(e)=>{
    ...
    try{
     ...
     await  axiosInstance.put( Url + clientSeleccionado._id, clientSeleccionado)
  ...
  const handleSubmitEdit = async (e) => {
    e.preventDefault();
    const response = await axiosInstance.put(`${Url}${clientSeleccionado.id}`, clientSeleccionado)

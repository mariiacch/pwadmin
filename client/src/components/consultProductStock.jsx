...
useEffect(() => {
  const getPro = async () => {
    const res= await axiosInstance.get(urlStock)
    try{
      setClients(res.data);
...
//filtra la data , los users que se queden son los que no coinciden con el user que se selecciono  setUsuarios(usuarios.filter(user=>user._id!==userSeleccionado._id));
  const eliminar = async()=>{
    ...
    try{
    await axiosInstance.delete(urlG + clientSeleccionado._id )
  ...
  const editar = async(e)=>{
    ...
    try{
     ...
     await axiosInstance.put( urlG + clientSeleccionado._id, clientSeleccionado)
        ...
        <div className="ConsultTable">
          ...
          <div className="ConsultHeader">
                ...
                <div className="buscadorInput">
                    ...
                    <Link to="/PdfStock" target="_blank">
